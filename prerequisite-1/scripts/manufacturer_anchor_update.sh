...
jq '.channel_group.groups.Application.groups.ManufacturerMSP.values += {"AnchorPeers":{"mod_policy": "Admins","value":{"anchor_peers": [{"host": "peer0-manufacturer","port": 7051}]},"version": "0"}}' config_copy.json > modified_config.json
