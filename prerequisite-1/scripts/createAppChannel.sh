...
osnadmin channel join --channelID $CHANNEL_NAME --config-block /channel-artifacts/$CHANNEL_NAME.block -o orderer:7051 --ca-file $ORDERER_CA --client-cert $ORDERER_ADMIN_TLS_SIGN_CERT --client-key $ORDERER_ADMIN_TLS_PRIVATE_KEY
